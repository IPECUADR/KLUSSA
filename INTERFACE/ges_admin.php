//Input oculto para almacenar el rol del usuario
<input
  type="hidden"
  id="rol_usuario"
  value="<?php echo (int) $rol; ?>">
        ...
        <div class="row g-3 align-items-center">
          ...
          <div class="col-12 col-lg-5">
            <div class="row g-2">
              ...
              <!-- Botón para registrar un nuevo gestor, visible solo para roles 1 y 2 -->
              <?php if (in_array((int) $rol, array(1, 2), true)): ?>
        ...
        <table class="table " id="tabla_res">
          <thead class="text-white" style="background: #212529;">
            <tr>
              ...
              <th scope="col" class="px-3 py-3">GESTOR</th>
...
<script src="../JS/gestores.fn.js"></script>