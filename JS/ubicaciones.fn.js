$(document).ready(function () {
  ...
  $.ajax({
    ...
    url:'../DATABASE/cg_ubicaiones.php',
...
`;
 ...
 <form id="detalle_residuo" class="container-fluid py-2">
  ...
  <div class="card border-0 shadow-sm">
    ...
    <!-- Nombre del tipo -->
    <div class="mb-3">
        <label for="nombre_tipo" class="form-label fw-bold">Ubicacion </label>
        <input type="text" class="form-control" id="ubicacion" name="ubicacion" placeholder="Ej: 	TALLER" required>
    </div>
...
// capturo datos del formulario
  ...
  if(ubicacion.length === 0 ) return mensaje('Debe insertar algo','warning');
 


 $.ajax({
    url: '../DATABASE/in_ubicacion.php',
    type: 'POST',
    data: { ubicacion },
