<div class="p-4 bg-light mt-5 mb-5">
  ...
  <div class="card  border-0 shadow-sm rounded-4">
    ...
    <div class="card-body bg-light mt-3 mb-4 rounded-4">
      ...
      <!-- RESUMEN DE TOTALES PARA CONSUMO DE ENERGIA SEDES POR VICTOR ALVAREZ -->
          ...
          <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
            <div>
              ...
              <small class="text-muted">
                El valor se actualiza según los filtros seleccionados.
              </small>
            </div>
          </div>

          <div id="resumen_total_energia" class="row g-2">
